...
import type { Config, GenericReport, Module, ModuleListenerInterface, Result } from "../../index.js"
 ...
 */
export function isModuleServer(module: Module): module is ModuleServerInterface {
